...
def test_goal_category_list(client, authorized_user_cookie, goal_category):
    ...
    response = client.get("/goals/goal_category/list", cookies=authorized_user_cookie)
...
def test_goal_category_retrieve(client, authorized_user_cookie, goal_category):
    ...
    response = client.get(f"/goals/goal_category/{goal_category.id}", cookies=authorized_user_cookie)
...
def test_goal_category_delete(client, authorized_user_cookie, goal_category):
    response = client.delete(f"/goals/goal_category/{goal_category.id}", cookies=authorized_user_cookie)
